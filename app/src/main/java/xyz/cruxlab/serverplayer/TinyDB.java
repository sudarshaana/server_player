...
public class TinyDB {
    ...
    public Map<String, Boolean> getMapObject(String key, Type classOfT) {

        String json = getString(key);
        Map<String, Boolean> value = new Gson().fromJson(json, classOfT);
        if (value == null)
            throw new NullPointerException();
        return value;
    }

    public Map<String, String> getMapCatObject(String key, Type classOfT) {

        String json = getString(key);
        Map<String, String> value = new Gson().fromJson(json, classOfT);
        if (value == null)
            throw new NullPointerException();
        return value;
    }

    //    public Map<String, Category> getMapCategory(String key, Type classOfT){
//
//        String json = getString(key);
//        Log.d(TAG, "getMapCategory: "+ json);
//        Map<String, Category> value = new Gson().fromJson(json, classOfT);
//        if (value == null)
//            throw new NullPointerException();
//        return value;
//    }
    public Map<Integer, String> getMapAccountType(String key, Type classOfT) {

        String json = getString(key);
        Map<Integer, String> value = new Gson().fromJson(json, classOfT);
        if (value == null)
            throw new NullPointerException();
        return value;
    }
    ...
    public void putObject(String key, Object obj) {
        ...
        Log.d(TAG, "putObject: " + gson.toJson(obj).toString());
    }
